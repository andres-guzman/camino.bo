...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/camino/full.jpg" />
        </div>
        
        <div id="project-view-description">
            <div id="project-view-header">
                <h1>Antiguo portafolio personal</h1>
                <h2>Diseño Web</h2>
            </div>

            <div id="project-view-text">
                Este el diseño previo al sitio web que estas viendo ahora (www.camino.bo). Hize este diseño hace bastante tiempo e incluso armé el font-end en Enero del 2017, pero decidí no usarlo oficialemnte.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/camino/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
