...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/file-properties/full.png" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				Por un tiempo tuve la idea crear una interfaz que muestre algunos datos sobre los visitantes de un sitio web. Parecido a Google Analytics.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/file-propert/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
