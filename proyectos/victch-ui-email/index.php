...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/victch-ui-email/full.png" />
        </div>
        
        <div id="project-view-description">
            <div id="project-view-header">
                <h1>Victch UI email</h1>
                <h2>Diseño de interfaz</h2>
            </div>

            <div id="project-view-text">
				Este es otro diseño de un cliente web de correo electrónico.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/victch-ui-email/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
