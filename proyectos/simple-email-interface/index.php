    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				Este es un diseño de una simple interfaz para algún cliente de correo electrónico. Personalmente me gusta la fuente y los colores.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/simple-email-interface/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
