...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/security-software-website/full.jpg" />
        </div>
        
        <div id="project-view-description">
            <div id="project-view-header">
                <h1>Security software website</h1>
                <h2>Diseño web</h2>
            </div>

            <div id="project-view-text">
				Esta es la página web de una empresa que ofrece software de seguridad. Algo como antivirus pero no tan utilizado.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/security-software-website/full.jpg" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
