...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/photoshop-event/full.jpg" />
        </div>
        
        <div id="project-view-description">
            <div id="project-view-header">
                <h1>Photoshop event</h1>
                <h2>Diseño web</h2>
            </div>

            <div id="project-view-text">
				Quise hacer un diseño sobre algún evento que ocurriera en la cuidad en la que vivo. Elegí un evento de Photoshop por que cada vez me interesa mas usar ese producto.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/photoshop-event/full.jpg" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
