...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/login-with-facebook/full.png" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				Hace tiempo hice este simple diseño para que un usuario inicie sesión con Facebook.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/login-with-facebook/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
