...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/print-invoice/full.png" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				Este es un diseño para las facturas de un pequeño negocio de impresión llamado Plotter Print en La Paz.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/print-invoice/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
