...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/strato/full.jpg" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
                Pequeño diseño de prueba de una página web.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/strato/full.jpg" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
