...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="proyectos/frontend/full.jpg" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				Este diseño salió de la idea que una vez tuve sobre una empresa ficticia que ofrece desarrollo front-end para personas que hacen sitios web.
            </div>
            ...
            <div id="project-view-download">
                <a href="proyectos/frontend/full.png" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
