...
<html lang="es-bo">
    <head>
        ...
        <title>Camino — Portafolio de Andres Guzman</title>
    ...
    <body>
        ...
        <div id="main" class="m-scene">
            <div id="nav-language">
                <span class="is-visible">Idioma — </span> <span id="nav-language-active">Español</span> <span class="nav-language-sep">\</span> <a href="../en/contact/">English</a>
            </div>
            ...
            <header>                                
                ...
                <div id="logo-caption">
                    Portafolio de Andres Guzman — Diseñador y desarrollador web
                </div>
                ...
                <nav>
                    <ul>
                        ...
                        <li class="nav-active">Contacto</li>
			...
			<div id="contact-flex">
				<main id="contact" class="scene_element scene_element--fadein">
					<h1>Si quisieras ponerte en contacto para que trabaje en tu proyecto, o solo para decir hola, por favor escríbeme a:</h1>
					...
					<div id="form-card" <?php echo $class ?> >
                        <p <?php echo $classError ?>>O puedes usar el formulario de contacto:</p>
                        <form id="formsubmit" action="./" method="post">
                            <table>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <textarea class="form-control" rows="3" id="message" name="message" placeholder="Mensaje:" required><?php echo htmlspecialchars($_POST['message']);?></textarea>
