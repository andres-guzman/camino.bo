...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
            <img src="../proyectos/balance/full.png" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				This small design is for a fictional business that offers printing services.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/balance/full.png" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
