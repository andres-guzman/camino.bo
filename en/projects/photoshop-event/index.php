    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				I wanted to create a design about an event involving Photoshop since I use that piece of software a lot. The event is suposed to take place in La Paz, Bolivia.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/photoshop-event/full.jpg" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
