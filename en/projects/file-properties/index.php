    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				This design is about an app that simply shows the properties of a file that has been selected.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/file-propert/full.png" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
