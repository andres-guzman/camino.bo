    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				Website desing for a business that offers software security. Very much like an antivirus but less popular.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/security-software-website/full.jpg" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
