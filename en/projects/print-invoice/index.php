    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				This is design for an invoice for a real small local business called Plotter Print, here in La Paz.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/print-invoice/full.png" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
