    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            <div id="project-view-header">
                <h1>Old personal portfolio</h1>
                <h2>Web design</h2>
            </div>

            <div id="project-view-text">
				This was meant to be my potfolio about a year ago. I went as far as fully developing this webiste but it never went online because I decided for this design intead.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/camino/full.png" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
