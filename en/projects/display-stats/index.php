    ...
    <div id="project-view-frame">
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				A while back I wanted to creat a design that shows stats and data, a little bit like Google Analytics does.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/display-stats/full.png" target="_blank">Download / Full view</a>
            </div>
        </div>
    </div>
