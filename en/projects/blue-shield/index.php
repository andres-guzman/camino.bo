...
<div id="project-view-modal">
    <div id="project-view-frame">
        <div id="project-view-image">
			<img src="../proyectos/blue-shield/full-A.jpg" />
			<img src="../proyectos/blue-shield/full-B.jpg" />
        </div>
        ...
        <div id="project-view-description">
            ...
            <div id="project-view-text">
				This is a simple design for a company that offers not so clear services. This design was inspired on a posible project I had to work in.
            </div>
            ...
            <div id="project-view-download">
                <a href="../proyectos/blue-shield/full-A.jpg" target="_blank">Descargar / Ver tamaño completo</a>
            </div>
        </div>
    </div>
